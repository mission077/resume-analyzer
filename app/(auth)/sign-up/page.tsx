...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === "complete") {
        ...
        setError(`Sign-up status: ${result.status}. Please try again.`)
      }
    } catch (err: any) {
      console.log("Sign-up error:", err) // For debugging
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[#fefcff] via-[#f3e8ff] to-[#e0f2fe]">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/30 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-lg">Sign up with email and password</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
             ...
             {/* Add CAPTCHA element : Sign-up require CAPTCHA for new account creation */}
